...
<div style="max-width:720px;margin:0 auto;background-color: #87b2ff;height: 100%;">
    ...
    <div style="border:  1px solid #007aff;width: 100%;height: 20px;margin-top: 5px;">
        <div id="demo15" class="mui-progressbar" style="height: 18px;background: #fff;">
            <span></span>
            <div style="position: absolute; left: 45%; color: orange; top: 0">97%</div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        back_listener();
        mui("#demo15").progressbar({progress:97}).show();
    })
</script>
</html>
